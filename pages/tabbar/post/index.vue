	...
	<view class="content" :class="{'active':active}">
		...
		<view class="tabbar-box-wrap">
			<view class="tabbar-box">
				<view class="tabbar-box-item" @click="goToPage('/pages/post-detial/post-graphic/index')">
					<image class="box-image" src="../../../static/img/release.png" mode="aspectFit"></image>
					<text class="explain">发图文</text>
				</view>
				<view class="tabbar-box-item" @click="goToPage('/pages/post-detial/post-good/index')">
					<image class="box-image" src="../../../static/img/qa.png" mode="aspectFit"></image>
					<text class="explain">发商品</text>
				</view>
				<view class="tabbar-box-item" @click="goToPage('/pages/post-detial/post-video/index')">
